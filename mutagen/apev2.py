...
class APEv2(_CIDictProxy, Metadata):
    ...
    def save(self, filename=None):
        ...
        filename can be a str showing the path or an object opened in mode r+b.
        ...
        try:
            fileobj = get_fileobj(self, filename)
        except IOError:
            # IOError happens when filename is a str and the file in that path
            # does not exist
