    ...
    def save(self, filename=None, v1=1, v2_version=4, v23_sep='/'):
        ...
        Args:
            filename:
                ...
                the one most recently loaded is used. filename can also be a
                file object opened in mode r+b.
            v1 (ID3v1SaveOptions):
        ...
        try:
            ...
            # IOError only happens when filename is a path and does not exist
            from errno import ENOENT
            if err.errno != ENOENT:
                raise
